...
import com.example.cat.activities.AluminiActivity;
import com.example.cat.activities.MainActivity;
import com.example.cat.dataModels.AdTypes;
    ...
    private void setListeners() {
        cardView[0].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(getActivity(), AluminiActivity.class);
        ...
        cardView[4].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle args = new Bundle();
                args.putString(Frag_Ads.ARGS_AdType, AdTypes.NOTES);
                frag_ads.setArguments(args);
        ...
        cardView[5].setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Bundle args = new Bundle();
                args.putString(Frag_Ads.ARGS_AdType, AdTypes.BLOGS);
                frag_ads.setArguments(args);
