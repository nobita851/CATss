...
import com.example.cat.adapters.NewAdImageAdapter;
import com.example.cat.cameraIntentHelper.ImageUtils;
import com.example.cat.dataModels.AdData;
import com.example.cat.dataModels.DateObject;
...
import static com.example.cat.Fragments.Frag_Ads.ARGS_AdType;
...
//                        adData.setPrice(Integer.valueOf(etPrice.getText().toString()));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 19 && resultCode == RESULT_OK && data != null) {
            ...
            Toast.makeText(getActivity().getBaseContext(),"Please Select file",Toast.LENGTH_LONG).show();
    ...
    public void uploadfile(Uri data)
    {
        ...
        StorageReference storageReference= FirebaseStorage.getInstance().getReference().child("notes").child(name);
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Toast.makeText(getActivity().getBaseContext(),"File Successfully uploaded",Toast.LENGTH_LONG).show();
