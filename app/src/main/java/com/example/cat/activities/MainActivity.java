...
import com.example.cat.Fragments.Frag_Ads;
import com.example.cat.Fragments.Frag_LoginPage;
import com.example.cat.Fragments.Frag_Main;
import com.example.cat.Fragments.Frag_Manage;
import com.example.cat.Fragments.Frag_myAds;
import com.example.cat.Fragments.Frag_myProfile;
import com.example.cat.Fragments.Frag_newAccount;
import com.example.cat.Fragments.Frag_newAd;
import com.example.cat.Fragments.Frag_newEvent;
import com.example.cat.Network.CloudStorageMethods;
import com.example.cat.Network.ConnectionDetector;
...
import com.example.cat.dataModels.UserCred;
...
import static com.example.cat.activities.OnboardingActivity.PREFERENCES_FILE;
import static com.example.cat.dataModels.AdTypes.TYPE_EVENT;
import static com.example.cat.dataModels.AdTypes.TYPE_INFO;
import static com.example.cat.dataModels.AdTypes.TYPE_LOSTFOUND;
import static com.example.cat.dataModels.AdTypes.TYPE_SELL;
import static com.example.cat.dataModels.AdTypes.TYPE_TEACH;
...
public class MainActivity extends AppCompatActivity {
    ...
    public final static String TITLE_MainScreen = "College Archives & Times";
        ...
        if(userInfo.getHasProfileIMG()) {
            ...
            cloudStorageMethods.getProfileImage(userInfo.getuID(), new onCompleteListener<Uri>() {
                ...
                public void onFailure(Exception e) {
                    ...
                    Glide.with(context).load(R.drawable.avatar).into(imageView);
